...
/**
 * This program prompts the user to select a option for calculating
 * depreciated value. The two options are standard and optional. While
 * standard option calculates a depreciated value of an item entered by the
 * user. It asks the user to input description of the item, original value
 * and the annual depreciation. It also calculates the accumulated
 * depreciation value. Repeats the program as many times the user wants.
 * Option two which is optional prompts user to enter the number of years for
 * complete depreciation, and then prints the table.
 *
...
public class DepreciationEC 
{
    ...
    public static void main(String[] args) 
    {
        ...
        int option;                    // To hold users input
        ...
        do {
            ...
            System.out.println("\nWhich depreciation report would you " +
                    "like to " + "run? ");
            ...
            System.out.print("\n\nDo you want to depreciate another item "
                    + "(y/n)?" + " ");
            input = keyboard.next();
     ...
     *
     * @param keyboard For taking input from command line.
     * @return Returns noOfYears value entered by user.
     */
    public static int getNoOfYears(Scanner keyboard) 
    {
        int noOfYears;
        do {
            System.out.print("Enter the number of years it takes the " +
                    "equipment to " + "fully depreciate: ");
