...
/**
 * This program will prompt the user to input a number between the range
 * of 5 to 25, and then using two different functions(input and calculate),
 * will carry out a mathematical calculation and display the result on the
 * console.
 *
...
public class Functions
{
    ...
    /**
     * Prompts user to enter a number between the specified low and
     * high range,and then performs a mathematical operation on the
     * inputted number.
     *
    ...
    public static void main(String[] args)
    {
        ...
        //Call goodbye function print welcome message
        goodbye();
    }
    ...
    {
        System.out.print("Welcome to the Functions program! " +
                "The program will request a number \n" +
    ...
    public static int input()
    {
        ...
        return number;           // Returns the valid number where the
                                                // function was called.
    }

    /**
     * Performs a mathematical operation on a number, and then
     * returns the result of the operation where the calculate function
     * was called.
     *
