...
public class Chutes
{
    ...
    // Declaring Declaring random to generate spin outcome
    ...
    public static void setPlayerDetails(Scanner keyboard)
    {
        ...
        int playerCount = 0;                   // To hold PlayerCount
    ...
    public static int playGame()
    {
        ...
        do
        {
            ...
            System.out.println(playerName + ", it's your turn. You are " +
                    "currently" + " at space " + playerLocations[player]);
            ...
            else
            {
                ...
                // Ladder case to move forward
                if(offset > 0)
                {
                    System.out.println("Congrats, that is a ladder! You get to"
                            + " climb " + offset + " spaces.");
                }
                // Chute case to move backwards
                else if(offset < 0)
                {
                ...
                // After adding offset, the player can reach at 100th location
