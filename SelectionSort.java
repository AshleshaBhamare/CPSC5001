...
public class SelectionSort {
    ...
    /**
     * This function gets the file name, displays on the console
     * After displaying on console, selection sort function is called
     * and then sorted array is again displayed on the console.
     *
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        final String FILE_NAME = "/home/fac/ohsh/submit/20rq5001/files/"
                + "lab9input.txt" ;
        System.out.println("\n");
    ...
    /**
     * This function reads the content from the filename and then stores
     * it in an array.
     *
    ...
    /**
     * This function carries out the sorting of the elements present
     * in the array
     *
     * @param array The entered array.
